...
class Agros_class:
    ...
    def choropleth(self, year):
        ...
        #Get the average of the tfp of country in that given year for the case that we have >1 tfp values
    ...
    def predictor(self,*countries):
        ...
        #predictor_data = self.data(self.data["Entity"].isin(valid_countries)
